...
class PrintedBook(title: String, author: String, year: Int, pages: Int,price: Double,initialCopies: Int, isbn: String) : Book(title, author, year, pages, price, initialCopies, isbn) {
